...
isPlus = false // začínáme na false protože nechceme sčítat jako první 

for (let i = 3; i <= 50000000; i+=2){ // tady jdeme od 3 (první číslo v řadě po 1) do 10000 (může to být jakkoliv jiné číslo jen čím je menší tím má i menší přesnost)
    if (isPlus){ // pokud isPlus je true tak budeme sčítat 
        pi += 1/i //protože sčítáme zlomek 1/n potřebujeme ho tady sčíst
    }
    else{ // v tuto chvíli víme že isPkus musí být false s proto budeme odečítat 
